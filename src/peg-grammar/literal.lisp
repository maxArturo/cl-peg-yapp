...
(peg-parser:define-parent-expr upper-case (peg-parser:char-range-terminal #\A #\Z))
...
(peg-parser:define-parent-expr lower-case (peg-parser:char-range-terminal #\a #\z))
...
(peg-parser:define-parent-expr string-literal
  (peg-parser:compose
    ...
    (peg-parser:one-or-more
      (peg-parser:compose
        (peg-parser:negative-lookahead (peg-parser:literal-char-terminal #\')) 
...
(peg-parser:define-parent-expr digit (peg-parser:char-range-terminal #\0 #\9))
(5am:test digit-test
  (5am:is 
    (funcall 'digit
             (coerce "0bacon" 'list)))
...
(peg-parser:define-parent-expr uphex
  (peg-parser:or-expr 
    (peg-parser:char-range-terminal #\A #\Z)
    (peg-parser:char-range-terminal #\0 #\9)))
#+5am
(5am:test uphex-test
...
(peg-parser:define-parent-expr unicode
  (peg-parser:compose (peg-parser:literal-char-terminal #\u)
      (peg-parser:or-expr
        (peg-parser:compose
